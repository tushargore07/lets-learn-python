# There will be no changes in the code if change the seld form any word \
# The word self is oonly for readiability 
...
class Train: 
     ...
     def __init__(tushar,trainno):
          tushar.trainno= trainno
